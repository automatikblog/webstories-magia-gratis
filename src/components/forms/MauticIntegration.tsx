          ...
          <div className="mauticform-innerform">
            <div className="mauticform-page-wrapper mauticform-page-1" data-mautic-form-page="1">
              <div id="mauticform_appwebstories_nome" className="mauticform-row mauticform-text mauticform-field-1">
                <textarea id="mauticform_input_appwebstories_nome" name="mauticform[nome]" className="mauticform-textarea" readOnly></textarea>
              </div>
              <div id="mauticform_appwebstories_email" data-validate="email" data-validation-type="email" className="mauticform-row mauticform-email mauticform-field-2 mauticform-required">
                <input id="mauticform_input_appwebstories_email" name="mauticform[email]" defaultValue="" className="mauticform-input" type="email" readOnly />
              </div>
              <div id="mauticform_appwebstories_telefone" data-validate="telefone" data-validation-type="textarea" className="mauticform-row mauticform-text mauticform-field-3 mauticform-required">
                <textarea id="mauticform_input_appwebstories_telefone" name="mauticform[telefone]" className="mauticform-textarea" readOnly></textarea>
              </div>
              <div id="mauticform_appwebstories_utm_source" className="mauticform-row mauticform-text mauticform-field-4">
                <textarea id="mauticform_input_appwebstories_utm_source" name="mauticform[utm_source]" className="mauticform-textarea" readOnly></textarea>
              </div>
              <div id="mauticform_appwebstories_utm_campaign" className="mauticform-row mauticform-text mauticform-field-5">
                <textarea id="mauticform_input_appwebstories_utm_campaign" name="mauticform[utm_campaign]" className="mauticform-textarea" readOnly></textarea>
              </div>
              <div id="mauticform_appwebstories_utm_medium" className="mauticform-row mauticform-text mauticform-field-6">
                <textarea id="mauticform_input_appwebstories_utm_medium" name="mauticform[utm_medium]" className="mauticform-textarea" readOnly></textarea>
              </div>
              <div id="mauticform_appwebstories_utm_content" className="mauticform-row mauticform-text mauticform-field-7">
                <textarea id="mauticform_input_appwebstories_utm_content" name="mauticform[utm_content]" className="mauticform-textarea" readOnly></textarea>
              </div>
              <div id="mauticform_appwebstories_utm_term" className="mauticform-row mauticform-text mauticform-field-8">
                <textarea id="mauticform_input_appwebstories_utm_term" name="mauticform[utm_term]" className="mauticform-textarea" readOnly></textarea>
              </div>
              <div id="mauticform_appwebstories_cidade" className="mauticform-row mauticform-text mauticform-field-9">
                <textarea id="mauticform_input_appwebstories_cidade" name="mauticform[cidade]" className="mauticform-textarea" readOnly></textarea>
              </div>
              <div id="mauticform_appwebstories_estado" className="mauticform-row mauticform-text mauticform-field-10">
                <textarea id="mauticform_input_appwebstories_estado" name="mauticform[estado]" className="mauticform-textarea" readOnly></textarea>
              </div>
              <div id="mauticform_appwebstories_pais" className="mauticform-row mauticform-text mauticform-field-11">
                <textarea id="mauticform_input_appwebstories_pais" name="mauticform[pais]" className="mauticform-textarea" readOnly></textarea>
              </div>
              <div id="mauticform_appwebstories_dispositivo" className="mauticform-row mauticform-text mauticform-field-12">
                <textarea id="mauticform_input_appwebstories_dispositivo" name="mauticform[dispositivo]" className="mauticform-textarea" readOnly></textarea>
              </div>
              <div id="mauticform_appwebstories_url_pagina" className="mauticform-row mauticform-text mauticform-field-13">
                <textarea id="mauticform_input_appwebstories_url_pagina" name="mauticform[url_pagina]" className="mauticform-textarea" readOnly></textarea>
              </div>
              <div id="mauticform_appwebstories_app_blogwp" data-validate="app_blogwp" data-validation-type="select" className="mauticform-row mauticform-select mauticform-field-14 mauticform-required">
                <select id="mauticform_input_appwebstories_app_blogwp" name="mauticform[app_blogwp]" defaultValue="" className="mauticform-selectbox" readOnly>
                  <option value=""></option>
              ...
              <div id="mauticform_appwebstories_app_plano" className="mauticform-row mauticform-text mauticform-field-15">
                <input id="mauticform_input_appwebstories_app_plano" name="mauticform[app_plano]" defaultValue="" className="mauticform-input" type="text" readOnly />
              </div>
              <div id="mauticform_appwebstories_referrer" className="mauticform-row mauticform-text">
                <textarea id="mauticform_input_appwebstories_referrer" name="mauticform[referrer]" className="mauticform-textarea" readOnly></textarea>
              </div>
              <div id="mauticform_appwebstories_user_agent" className="mauticform-row mauticform-text">
                <textarea id="mauticform_input_appwebstories_user_agent" name="mauticform[user_agent]" className="mauticform-textarea" readOnly></textarea>
              </div>
              <div id="mauticform_appwebstories_screen_resolution" className="mauticform-row mauticform-text">
                <textarea id="mauticform_input_appwebstories_screen_resolution" name="mauticform[screen_resolution]" className="mauticform-textarea" readOnly></textarea>
              </div>
              <div id="mauticform_appwebstories_timezone" className="mauticform-row mauticform-text">
                <textarea id="mauticform_input_appwebstories_timezone" name="mauticform[timezone]" className="mauticform-textarea" readOnly></textarea>
              </div>
              <div id="mauticform_appwebstories_clickid" className="mauticform-row mauticform-text">
                <input id="mauticform_input_appwebstories_clickid" name="mauticform[clickid]" defaultValue="" className="mauticform-input" type="text" readOnly />
              </div>
